                    ...
                    <div className="container">
                        <div className="box-get-quote">
                            <div className="get-quote-left">
                                ...
                                <h2 className="color-brand-1 wow animate__animated animate__fadeIn" style={{fontSize:'35px'}}>Innovation-Collaboration-Accountability</h2>
                            </div>
                            <div className="get-quote-right"><Link style={{width:'170px', padding:'10px', fontSize:'14px', color:'#fff'}} className="btn btn-get-quote wow animate__animated animate__fadeIn" href="/request-a-quote">

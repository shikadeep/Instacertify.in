                        ...
                        <div className="row align-items-center m-0">
                            <div className="col-lg-6">
                                <div className="box-login-left">
                                    ...
                                    <h3 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">Log in</h3>
                                    ...
                                    <div className="box-or-login wow animate__animated animate__fadeIn"><span className="text-or font-xs color-grey-500">Or continue with</span>
                                    </div> */}

                            ...
                            <div className="col-lg-6">
                                <div className="box-faqs-left">
                                    ...
                                    <div className="box-gallery-faqs">
                                        <div className="image-top"><img src="/assets/imgs/page/homepage1/faq-img2.jpg" alt="instacertify" /></div>
                                        <div className="image-bottom">
                                            <div className="image-faq-1"><img src="/assets/imgs/page/homepage1/faq-img3.jpg" alt="instacertify" /></div>
                                            <div className="image-faq-2"><img src="/assets/imgs/page/homepage1/faq-img1.jpg" alt="instacertify" /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>

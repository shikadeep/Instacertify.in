                ...
                <div className="container">
                    ...
                    <div className="main-header">
                        <div className="header-left">
                            <div className="header-logo d-inline-block d-md-none"><Link className="d-flex" href="/"><img alt="instacertify" src="/assets/insta-logo-1.png" /></Link></div>
                            ...
                            <div className="header-right">
                                ...
                                {/* <Link className="btn btn-default mr-10 hover-up" href="/login">Login</Link> */}
                                    <Link className="btn btn-brand-1 d-none d-xl-inline-block hover-up" href="/request-a-quote">
                                        <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">

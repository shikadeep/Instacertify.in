                ...
                <div className="box-bar bg-grey-900">
                    <div className="container position-relative">
                        <div className="row align-items-center">
                            <div className="col-lg-7 col-md-8 col-sm-5 col-4"> <Link className="phone-icon mr-45" href="tel:+91 9999118039">
                                <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z">
                                    </path>
                                </svg>Phone: +91 9999118039</Link><Link className="email-icon" href="mailto:contact@instacertify.com">
                                    <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75">
                                        </path>
                                    </svg>contact@instacertify.com</Link></div>
            ...
            <header className={scroll ? "header sticky-bar  header-style-2 stick" : "header sticky-bar  header-style-2"}>
                <div className="container">
                    <div className="header-middle">
                        <div className="header-logo"><Link className="d-flex" href="/"><img alt="instacertify" src="/assets/imgs/template/ic-logo.svg" /></Link></div>
                        <div className="header-contact">
                            <div className="box-header-contact-1 mr-30">
                                <div className="icon-contact"> <img alt="instacertify" src="/assets/imgs/page/homepage3/address.png" /></div>
                                <div className="info-contact">65 Allerton Street 901 N Pitt Str, USA</div>
                            </div>
                            <div className="box-header-contact-2">
                                <div className="icon-contact"> <img alt="instacertify" src="/assets/imgs/page/homepage3/phone.png" /></div>
                                <div className="info-contact">65 Allerton Street 901 N Pitt Str, USA</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="main-header">
                        <div className="header-left">
                            <div className="header-logo d-inline-block d-md-none"><Link className="d-flex" href="/"><img alt="instacertify" src="/assets/imgs/template/ic-logo.svg" /></Link></div>
                            ...
                            <div className="header-right">
                                <div className="d-inline-block box-dropdown-cart"><span className="font-lg icon-list icon-account"><span className="font-sm color-grey-900 arrow-down">
                                    ...
                                    <div className="dropdown-account">
                                        <ul>
                                            <li><Link className="font-md" href="#"><img src="/assets/imgs/template/icons/en.png" alt="instacertify" />
                                                English</Link></li>
                                            <li><Link className="font-md" href="#"><img src="/assets/imgs/template/icons/fr.png" alt="instacertify" />
                                                French</Link></li>
                                            <li><Link className="font-md" href="#"><img src="/assets/imgs/template/icons/cn.png" alt="instacertify" />
                                                Chiness</Link></li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="d-none d-sm-inline-block"><Link className="btn btn-default mr-10 hover-up" href="/login">Login</Link>
                                    <Link className="btn btn-brand-1 d-none d-xl-inline-block hover-up" href="/add-to-cart">

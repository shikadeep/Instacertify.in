            ...
            <header className={scroll ? "header sticky-bar  header-style-2 stick" : "header sticky-bar  header-style-2"}>
                <div className="container">
                    <div className="header-middle">
                        <div className="header-logo"><Link className="d-flex" href="/"><img alt="transp" src="/assets/imgs/template/ic-logo.svg" /></Link></div>
                    ...
                    <div className="main-header">
                        <div className="header-left">
                            <div className="header-logo d-inline-block d-md-none"><Link className="d-flex" href="/"><img alt="Ecom" src="/assets/imgs/template/ic-logo.svg" /></Link></div>

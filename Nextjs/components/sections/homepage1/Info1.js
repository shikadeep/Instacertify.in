        ...
        <>
            <section className="section mt-85">
                <div className="container">
                    ...
                    <h3 className="color-brand-2 mb-65 mt-15 wow animate__animated animate__fadeIn"> InstaCertify certification made simple.
                             </h3>
                    ...
                    <div className="row mt-50 align-items-center">
                        ...
                        <div className="col-xl-5 col-lg-6 mb-30">
                            <div className="box-info-pround">
                                <h3 className="color-brand-2 mb-15 wow animate__animated animate__fadeIn">Simply your path to product certification excellence with our expert solutions</h3>
                                <p className="font-md color-grey-500 wow animate__animated animate__fadeIn">We are India's leading product testing and compliance solutuion partner,
                                     driving rapid industry growth. Specializing in quality testing and consulting, we cover a wide array of certifications, including BIS, CRS, ISI, CDSCO, WPC, IMEI-DOT, 
